...
import about from "@/public/sikkim-students.png";
      ...
      <div className="flex flex-col-reverse md:flex-row justify-center space-x-6 px-4 lg:px-24">
        ...
        <div className="w-full xl:pl-8 p-1">
          ...
          >
            ...
            Education ignites Transformation
          </motion.p>
          <p className="font-semibold text-xl md:text-2xl xl:text-3xl mb-1 lg:mb-4 text-left">
            Atal Bihari Vajpayee Skill University Secondary & Senior Secondary Education
          </p>
          <p className="text-gray-500 mb-2 text-justify text-xs md:text-sm lg:text-base">
            Atal Bihari Vajpayee Skill University was formed and incorporated
            by the Sikkim legislature through its official gazette and is
            recognised by the UGC Act 1956 under clause 2(f). Atal Bihari Vajpayee Skill University is a futuristic model for young India that
        ...
        <Link
  href="#programme"
  className="group uppercase bg-blue-950 text-white mt-3 md:mt-4 lg:mt-8 
             p-2 lg:p-4 rounded-lg xl:rounded-2xl px-4 lg:px-6 font-bold 
             flex gap-1 cursor-pointer transition-all duration-300 
             items-center text-sm md:text-base lg:text-lg w-full justify-center 
             md:w-fit"
>
            View our program
