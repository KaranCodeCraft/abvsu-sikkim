    ...
    <main className="bg-white text-gray-800">
      ...
      <section className="py-10 px-6 max-w-7xl mx-auto">
        ...
        <p className="text-lg text-gray-700">
          The library at Sikkim Global Technical University (SGTU) stands as a vital resource for students, faculty, and researchers, fostering an environment of knowledge and academic excellence.
        </p>
      </section>
