    ...
    <div className="bg-white">
      ...
      <div className="py-20 px-4 md:px-16">
        ...
        <div className="space-y-6">
          ...
          <p>
            The Women Sexual Harassment Committee at SGTU recognizes the importance of creating a supportive network for women on campus. The committee encourages collaboration with local NGOs, legal aid organizations, and women’s rights groups to provide additional resources and support for victims. By fostering these partnerships, the committee aims to enhance the support system available to women and ensure they have access to the help they need.
          </p>
          <p>
            Overall, the Women Sexual Harassment Committee at SGTU is dedicated to creating a safe, respectful, and empowering environment for all women in the university community. By addressing issues of sexual harassment, promoting awareness, and advocating for women’s rights, the committee plays a crucial role in fostering a culture of safety, respect, and equality within the campus.
          </p>
        </div>
      </div>
    </div>
