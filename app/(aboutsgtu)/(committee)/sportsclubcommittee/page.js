    ...
    <div className="bg-white">
      ...
      <div className="py-20 px-4 md:px-16">
        ...
        <div className="space-y-6">
          ...
          <p>
            Furthermore, the Sports Club Committee collaborates with external organizations and sports professionals to provide expert coaching and training sessions. This partnership enriches the sports program at SGTU, giving students access to professional guidance and resources. Workshops on sports management, health, nutrition, and injury prevention are also organized to educate students about the various aspects of sports and fitness.
          </p>
          <p>
            Overall, the Sports Club Committee at SGTU is dedicated to fostering a vibrant sports culture within the university. By organizing a wide range of sports activities and promoting physical fitness, the committee not only enhances students’ athletic abilities but also contributes to their personal growth and well-being. The committee's efforts ensure that every student has the opportunity to engage in sports, build lifelong friendships, and develop essential skills that extend beyond the playing field.
          </p>
        </div>
      </div>
    </div>
