...
const Page = () => {
  ...
  <section className="py-16 px-4 md:px-16 bg-white">
      ...
      <div>
        ...
        <div className="space-y-5 text-gray-700 text-base leading-7 text-justify">
         ...
         <p>
          ...
          <p>
            Offering a wide range of traditional degree programs and industry-relevant vocational courses, ABVSU is dedicated to meeting the demands of a rapidly evolving global economy. The university has forged strong placement partnerships with leading multinational companies(MNCs), ensuring exceptionatcareer opportunities for its graduates.
          </p>
          <p>
            Reinforcing our commitment to inclusive education and regional development, ABVSU provides a 25% reservation for local Sikkimese students and faculty members, ensuring that the benefits of quality education reach the local community.
          </p>
          <p>
            ABVSU is sponsored by the Indira Gandhi Computer Saksharta Mission (IGCSM), an organization established in 2008, renowned for its impactful work in skill development, digital literacy and educational innovation.
          </p>
          <p>
          ...
          <p className="italic font-medium text-orange-700">
            Step into the future with ABVSU — where innovation meets inspiration, and education transforms lives.
          </p>
        </div>
      </div>
    ...
    <div className="max-w-7xl mx-auto space-y-5 text-gray-700 text-base leading-7 text-justify mt-6">
     ...
     {/* <p>
            ABVSU has acquired 10-acre land and is set to expand it up to 45 acres, perfectly positioned in the heart of Namchi. The university currently houses four constituent campuses, featuring a modern built-up area of approx. 75,000 sq. ft., designed to foster excellence in learning and innovation.
          </p> */}
