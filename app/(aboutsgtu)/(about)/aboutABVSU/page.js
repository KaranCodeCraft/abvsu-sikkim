    ...
    <div className="bg-white relative">
      <div className="relative bg-[#2f2c2c] text-white py-10 px-4 md:px-16 z-10">
        <div className="relative z-10">
          <h1 className="text-3xl font-bold mb-2">About ABVSU</h1>
          <div className="text-sm font-medium">
            <Link href="/" className="text-white hover:text-orange-400">
              Home
            </Link>
            <span className="mx-2">/</span>
            <span className="text-white">About ABVSU</span>
          </div>
        </div>
      ...
      <main className="relative z-10">
        ...
        <section className="py-16 px-4 md:px-16 bg-white">
          <div className="grid gap-12 items-start max-w-7xl mx-auto">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-orange-600">
                About Atal Bihari Vajpayee Skill University (ABVSU)
              </h2>
              <div className="space-y-5 text-gray-700 text-base leading-7 text-justify">
                <p>
                  Atal Bihari Vajpayee Skill University (ABVSU), established in
                  2025, is a premier private institution located in Pankyong,
                ...
                <p>
                  Our library, housing more than 5,000 volumes, is a cornerstone
                  of our academic ecosystem, empowering students and researchers
                  with extensive learning resources and research materials.
                </p>
                <p>
                  Offering a wide range of traditional degree programs and
                  industry-relevant vocational courses, ABVSU is dedicated to
                  meeting the demands of a rapidly evolving global economy. The
                  university has forged strong placement partnerships with
                  leading multinational companies(MNCs), ensuring
                  exceptionatcareer opportunities for its graduates.
                </p>
                <p>
                  Reinforcing our commitment to inclusive education and regional
                  development, ABVSU provides a 25% reservation for local
                  Sikkimese students and faculty members, ensuring that the
                ...
                <p>
                  ...
                  transformation. In 2023, it was awarded the responsibility of
                  operating 3 Industrial Training Institutes (ITIs) and 5
                  Polytechnic Institutes across Uttar Pradesh, under the
                  Public-Private Partnership (PPP) model, showcasing its proven
                  excellence in the vocational education sector.
                </p>
                <p className="italic font-medium text-orange-700">
                  Step into the future with ABVSU — where innovation meets
                  inspiration, and education transforms lives.
                </p>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto space-y-5 text-gray-700 text-base leading-7 text-justify mt-6">
            {/* <p>
            ABVSU has acquired 10-acre land and is set to expand it up to 45 acres, perfectly positioned in the heart of Pakyong. The university currently houses four constituent campuses, featuring a modern built-up area of approx. 75,000 sq. ft., designed to foster excellence in learning and innovation.
          </p> */}
          </div>
        </section>
                  ...
                  <React.Fragment key={index}>
                    <div
                      ...
                      style={{
                        ...
                        width: `${lineLength}px`,
                        height:
                          hoveredSchoolIndex === index ? "2.5px" : "1.5px",
                        backgroundColor:
                          hoveredSchoolIndex === index ? "#FF6900" : "#e5e7eb",
            ...
            <div>
              ...
              <div className="text-black text-base leading-7 text-justify">
                <div className="space-y-4">
                  <p>
                    <strong>Tranquil Surroundings:</strong> Surrounded by
                    majestic mountains and lush greenery, our campus offers a
                    serene environment, ideal for focused learning and personal
                    growth.
                  </p>
                  <p>
                    <strong>Cultural Diversity:</strong> Immerse yourself in
                    vibrant festivals, serene monasteries, and local customs,
                    enriching your global perspective and fostering a sense of
                    community.
                  </p>
                  <p>
                    <strong>Outdoor Adventures:</strong> Explore thrilling
                    outdoor activities like trekking, mountaineering, and white
                    water rafting, making the most of Sikkim's natural beauty
                    during your free time.
                  </p>
                </div>
                <div className="space-y-4 mt-4">
                  <p>
                    <strong>Affordable Living:</strong> Enjoy the benefits of
                    affordable living in Sikkim, making it a budget-friendly
                    option for students seeking quality education.
                  </p>
                  <p>
                    <strong>Balanced Lifestyle:</strong> While nightlife options
                    may be limited, our campus prioritizes a balanced lifestyle,
                    combining academic excellence with cultural vibrancy and
                    natural beauty.
                  </p>
                  <p>
                    <strong>Join Our Community:</strong> Become part of a
                    vibrant community of scholars, innovators, and
                    change-makers, shaping the future of education and society.
                  </p>
                </div>
              </div>
              <p className="text-shadow-white text-shadow-2xl mt-8 font-medium italic">
                Welcome to Student Life at Atal Bihari Vajpayee Skill
                University. Your journey of learning, exploration, and growth
                begins here.
              </p>
            </div>
          </div>
