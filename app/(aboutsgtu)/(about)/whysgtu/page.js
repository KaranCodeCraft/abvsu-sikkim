  ...
  const focusAreas = [
    {
      ...
      points: [
        "ABVSU believes that education is about more than just gaining knowledge—it’s about shaping individuals to be compassionate, responsible, and equipped to tackle real-world challenges.",
    ...
    },
    {
      ...
      points: [
        "ABVSU’s innovative curriculum is designed to create graduates who are skilled, adaptable, and ready to take on the challenges of an interconnected world.",
    ...
    },
    {
      ...
      points: [
        "Education at ABVSU encompasses every aspect of student life, promoting holistic growth and personal well-being.",
        ...
        "At ABVSU, education is a transformative journey that prepares students for both professional success and personal fulfillment.",
      ],
    },
    {
      ...
      points: [
        ...
        "Every course at ABVSU is designed to enhance productivity, job prospects, and adaptability, making our students competitive and capable contributors in any field.",
      ],
    },
    {
      ...
      points: [
        "At ABVSU, our esteemed faculty are more than teachers—they are mentors, guides, and leaders dedicated to student success.",
        ...
        "This dedication to teaching excellence is a cornerstone of ABVSU’s educational philosophy.",
      ],
    },
    {
      ...
      points: [
        "ABVSU is committed to making education accessible to everyone.",
    ...
    },
    {
      ...
      points: [
        ...
        "ABVSU fosters a culture of sustainability, ethics, and community service, encouraging students to think beyond themselves and contribute to the betterment of society.",
    ...
    <div className="bg-white">
      ...
      <div className="relative bg-[#2f2c2c] text-white py-12 px-4 md:px-16 overflow-hidden">
        <div className="relative z-10 max-w-7xl mx-auto">
          <h1 className="text-4xl font-bold mb-2">Why ABVSU</h1>
          <div className="text-sm font-medium">
            <Link href="/" className="text-white hover:text-orange-400">
              Home
            </Link>
            <span className="mx-2">/</span>
            <span className="text-orange-400">Why ABVSU</span>
          </div>
        </div>
