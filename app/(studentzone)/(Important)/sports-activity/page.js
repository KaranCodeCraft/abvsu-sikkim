  ...
  return (
    <main className="space-y-20 px-4 py-16 max-w-7xl mx-auto">
      ...
      <section className="flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="md:w-1/2 space-y-6">
          ...
          <p className="text-gray-700 leading-relaxed">
            Atal Bihari Vajpayee Skill University (ABVSU) recognizes the vital role that sports and physical activity play in the holistic development of students. With an emphasis on fostering a healthy lifestyle and promoting teamwork, discipline, and leadership skills, ABVSU offers a dynamic sports program that encourages students to engage in a variety of physical activities and competitive sports. This commitment to sports not only enhances students’ physical well-being but also contributes to their personal growth and academic success.
          </p>
          <p className="text-gray-700 leading-relaxed">
            The university boasts state-of-the-art sports facilities that cater to a wide range of sports and physical activities. From outdoor fields for football, cricket, and athletics to indoor facilities for basketball, badminton, and table tennis, ABVSU provides students with ample opportunities to participate in various sports. The campus is designed to promote an active lifestyle, encouraging students to take advantage of these facilities for both recreational and competitive purposes.
          </p>
        </div>
      ...
      <section className="flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="md:w-1/2 space-y-6">
          <p className="text-gray-700 leading-relaxed">
            ABVSU organizes inter-college sports competitions and events throughout the academic year, providing students with opportunities to showcase their talents and compete against peers from other institutions. These competitions foster a spirit of healthy rivalry and encourage students to strive for excellence. Additionally, participation in sports events often leads to the development of friendships and networks that can last a lifetime. The university also hosts annual sports days, celebrating student achievements and promoting sports culture on campus.
          </p>
          <p className="text-gray-700 leading-relaxed">
