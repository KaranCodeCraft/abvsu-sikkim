      ...
      <section className="flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="md:w-1/2 space-y-6">
          ...
          <p className="text-gray-700 leading-relaxed">
            Atal Bihari Vajpayee Skill University (SGTU) recognizes the vital role that sports and physical activity play in the holistic development of students. With an emphasis on fostering a healthy lifestyle and promoting teamwork, discipline, and leadership skills, SGTU offers a dynamic sports program that encourages students to engage in a variety of physical activities and competitive sports. This commitment to sports not only enhances students’ physical well-being but also contributes to their personal growth and academic success.
          </p>
          <p className="text-gray-700 leading-relaxed">
