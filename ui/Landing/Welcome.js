    ...
    <div className="py-2 md:py-8 lg:py-16">
      <div className="flex flex-col-reverse md:flex-row justify-center space-x-6 px-4 lg:px-24">
        ...
        <div className="w-full xl:pl-8 p-1">
          ...
          >
            <AcademicCapIcon className="text-blue-900 h-8 w-8" />
          ...
          <p className="text-gray-500 mb-2 text-justify text-xs md:text-sm lg:text-base">
            The Atal Bihari Vajpayee Skill University was formed and incorporated
            by the Sikkim legislature through its official gazette no 251
            recognised by the Sikkim Vide Act No 13 of 2025. The Atal Bihari Vajpayee Skill University is a futuristic model for young India that
          ...
          <Link
            href={"/#programme"}
            className="group uppercase bg-blue-900 mt-3 md:mt-4 lg:mt-8 p-2 lg:p-4 rounded-lg xl:rounded-2xl px-4 lg:px-6 font-bold flex gap-1 cursor-pointer transition-all duration-300 items-center text-sm md:text-base lg:text-lg w-full justify-center md:w-fit text-white"
          >
            View our program
