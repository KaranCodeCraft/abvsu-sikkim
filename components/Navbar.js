  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className="w-1/4 items-center  flex pl-8  space-x-2">
            <Link href={"/"}>
              <Image
                src={logo}
                alt="ABVSU"
          ...
          <div className="w-3/4 items-center flex flex-col ">
            <div
              className={`w-full rounded-bl-2xl pt-1 px-4 overflow-hidden transition-all duration-500 ease-in-out ${
            ...
            <div className="w-full h-full">
              <div className="w-full h-full relative z-50 ">
                <nav className="flex justify-between w-full items-center font-medium h-full">
                  ...
                  <div className="flex space-x-1 items-center transition-all duration-500">
                    <div
